  ...
  render() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.fanBtnTxt}>
        <Text style={styles.fanBtnTxt1}>
          {Fanction}</Text>
        </View>
        ...
        <View style={styles.FnBtnTxt}>
        <Text style={styles.FnBtnTxt1}>
          หมายเลขเครื่อง {data}</Text>
        </View>
          ...
          <View style={styles.BoxStatus}>
            <Text 
              style={{
                ...
                fontWeight: 'bold',
                color: '#000',
              }} onPress={() => this.props.navigation.navigate('Status',{Fanction:this.state.PickerValueHolder})}>
              ชำระเงิน
            </Text> 
